TRAFFIC_CATEGORY = \
    {
        "train_all": {
            'hangzhou_baochu_tiyuchang_1h_10_11_2021':
                ['4a', 'roadnet_p4a_lt.json', 'flow.json'],
            ...
            'hangzhou_qingchun_yanan_1h_16_17_1504':
                ['4b', 'roadnet_p4b_lt.json', 'flow.json'],
            ...
            'hangzhou_baochu_tiyuchang_1h_13_14_1798':
                ['6a', 'roadnet_p6a_lt.json', 'flow.json'],
            ...
            'hangzhou_shenban_shixiang_1h_1309':
                ['6c', 'roadnet_p6c_lt.json', 'flow.json'],
            ...
            'hangzhou_qingchun_yanan_1h_7_8_1289':
                ['6e', 'roadnet_p6e_lt.json', 'flow.json'],
            ...
            'hangzhou_qingchun_yanan_1h_10_11_1406':
                ['8', 'roadnet_p8_lt.json', 'flow.json'],
        ...
        'test_heterogeneous': {
            'hangzhou_qingchun_yanan_1h_13_14_1536':
                ['4c', 'roadnet_p4c_lt.json', 'flow.json'],
            'hangzhou_tianmushan_xueyuan_1h_9_10_2178':
                ['4d', 'roadnet_p4d_lt.json', 'flow.json'],
            'hangzhou_baochu_tiyuchang_1h_8_9_2231':
                ['6b', 'roadnet_p6b_lt.json', 'flow.json'],
            'hangzhou_shenban_shixiang_1h_8_9_2032':
                ['6d', 'roadnet_p6d_lt.json', 'flow.json'],
            'hangzhou_tianmushan_xueyuan_1h_17_18_2062':
                ['6f', 'roadnet_p6f_lt.json', 'flow.json'],
        },
        'demo_train': {
            "demo_train_1364":
                ['8', 'roadnet_1_1.json', 'inter_4_1364.json'],
        }
    }
